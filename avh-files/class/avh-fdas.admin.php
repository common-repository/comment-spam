...
class AVH_FDAS_Admin {
	...
	function actionAdminMenu () {
		...
		$this->hooks['avhfdas_menu_overview'] = add_submenu_page( $folder, 'Comment Spam: ' . __( 'Overview', 'avh-fdas' ), __( 'Overview', 'avh-fdas' ), 'manage_network_options', $folder, array (&$this, 'doMenuOverview' ) );
		$this->hooks['avhfdas_menu_general'] = add_submenu_page( $folder, 'Comment Spam:' . __( 'General Options', 'avh-fdas' ), __( 'General Options', 'avh-fdas' ), 'manage_network_options', 'avh-fdas-general', array (&$this, 'doMenuGeneralOptions' ) );
		$this->hooks['avhfdas_menu_3rd_party'] = add_submenu_page( $folder, 'Comment Spam:' . __( '3rd Party Options', 'avh-fdas' ), __( '3rd Party Options', 'avh-fdas' ), 'manage_network_options', 'avh-fdas-3rd-party', array (&$this, 'doMenu3rdPartyOptions' ) );
	...
	function doMenuOverview () {
		...
		echo '<h2>' . __( 'Comment Spam - Overview', 'avhfdas' ) . '</h2>';
